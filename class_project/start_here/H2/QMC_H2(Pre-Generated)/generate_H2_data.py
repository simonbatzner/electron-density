...
sys.path.append('/home/steven/ML-electron-density/util')
...
def compute_H_energy(ecut=90,alat=.75,vacuum=5.29,relax=False,\
	...
	kpts = Kpoints(gridsize=[1, 1, 1], option='automatic', offset=False)
...
#	print(compute_H_energy(alat=.75, ecut=90, dimer=True, relax=True, vacuum=5))
	...
	spacing_outs=[ compute_H_energy(alat=a, ecut=90, dimer=True,relax=False,verbose=True,ncpu=2) for a in spacings]
...
#	plt.show()
	quick_density_gen(strain_vals=np.linspace(.5,1.5,150),ecut=90,verbose=True)
